...
using Tyuiu.BrukhovAA.Sprint6.Task4.V7.Lib;
using System.IO;
...
namespace Tyuiu.BrukhovAA.Sprint6.Task4.V7
{
    public partial class FormMain : Form
    {
        ...
        {
            MessageBox.Show("Таск 4 выполнил студент группы АСОиУб-23-1 Брюхов Алексей Андреевич", "Сообщение", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
